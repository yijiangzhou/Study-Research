...
%% Non-financial corporate debt, as a percent of GDP
% The algorithm is exactly the same
% All comments are therefore omitted

clear;clc
[data,txt] = xlsread('nfc_pgdp.xlsx');
...
table = cell2table(tempcell,'VariableNames',{'country','time','nfc_pgdp'});
writetable(table,'nfc_pgdp.csv');
